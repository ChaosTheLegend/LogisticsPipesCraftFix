...
public class ModuleEnchantmentSinkMK2MuiDynamic extends GenericModuleMUI<ModuleEnchantmentSinkMK2> {
    ...
    public ModuleEnchantmentSinkMK2MuiDynamic(ModuleEnchantmentSinkMK2 module, String prefix) {
        super(module, prefix);
    ...
    public ParentWidget addWidgets(ParentWidget widget, PanelSyncManager syncManager, boolean addPlayerInventory) {
        ...
        widget.child(
                new Flow(GuiAxis.Y).coverChildren().left(9).top(4).childPadding(4)
                        ...
                        .child(new TextWidget<>("Requested enchanted items")).child(buildFilterSlots(syncManager)));
