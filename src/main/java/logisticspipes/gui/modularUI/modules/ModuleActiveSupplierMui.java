        ...
        widget
            .child(new Column()
                ...
                .child(new CycleButtonWidget()
                    .width(120).height(16)
                    .value(
                        SyncHandlers.enumValue(ModuleActiveSupplier.SupplyMode.class, activeSupplierModule::getSupplyMode, activeSupplierModule::setSupplyMode))
                    .overlay(
                        IKey.lang(
                            () -> switch (activeSupplierModule.getSupplyMode()){
